...
def augment_images(source_images, cams, labels, preds, force_resize=False, resize_size=224):
    ...
    for im_idx, sim in enumerate(source_images[:10]):
        # the image
        sim = sim.numpy()
